...
public class UnrentCommand extends CommandAreaShop {
    ...
    public static boolean canUse(CommandSender person, GeneralRegion region) {
        ...
        if (person instanceof Player && region instanceof TransactionalRegion) {
            Player player = (Player) person;
            return ((TransactionalRegion) region).isTransactionHolder(player) && person.hasPermission("areashop.unrentown");
        }
        return false;
    }

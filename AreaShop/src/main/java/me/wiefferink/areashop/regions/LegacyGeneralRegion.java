...
public abstract class LegacyGeneralRegion implements IRegion, Comparable<LegacyGeneralRegion>, ReplacementProvider {
     ...
     */
    public LegacyGeneralRegion(YamlConfiguration config) {
        this.config = config;
        setup();
    }
     ...
     */
    public LegacyGeneralRegion(String name, World world) {
     ...
     */
    @Override
    public int compareTo(LegacyGeneralRegion o) {
    ...
    public boolean equals(Object region) {
        return region instanceof LegacyGeneralRegion && ((LegacyGeneralRegion) region).getRegionId().equals(getRegionId());
    }

    @Override
    public int hashCode() {
        return getRegionId().hashCode();
    }
     ...
     */
    public abstract RegionStatus getState();
    ...
    public String getLowerCaseName() {
        return getRegionId().toLowerCase();
    }
    ...
    public LimitResult limitsAllow(RegionType type, OfflinePlayer offlinePlayer, boolean extend) {
        ...
        LegacyGeneralRegion exclude = null;
        if (extend) {
            exclude = this;
        }
        String typePath;
     ...
     */
    public int hasRegionsInLimitGroup(OfflinePlayer player, String limitGroup, List<? extends LegacyGeneralRegion> regions, LegacyGeneralRegion exclude) {
        int result = 0;

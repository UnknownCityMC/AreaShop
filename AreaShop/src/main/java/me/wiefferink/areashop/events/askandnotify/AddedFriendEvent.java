 ...
 */
public class AddedFriendEvent extends CancellableRegionEvent<LegacyGeneralRegion> {
	 ...
	 */
	public AddedFriendEvent(LegacyGeneralRegion region, OfflinePlayer friend, CommandSender by) {
		super(region);
		this.friend = friend;
		this.by = by;
	}
